...
import { User, KeyRound, Eye, EyeOff, ArrowLeft } from 'lucide-react';
import logoImage from 'figma:asset/c6ff523027523f9f34067547c80a62e3cc4d7d77.png';
...
export function SignIn({ onSignUp, onBack }: SignInProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-5 w-24 h-24 bg-purple-500 rounded-full blur-3xl opacity-40" />
        <div className="absolute top-32 right-10 w-32 h-32 bg-pink-500 rounded-full blur-3xl opacity-30" />
        <div className="absolute bottom-40 left-1/4 w-28 h-28 bg-purple-600 rounded-full blur-3xl opacity-35" />
        <div className="absolute top-1/2 right-5 w-20 h-20 bg-purple-400 rounded-full blur-2xl opacity-40" />
        <div className="absolute bottom-20 right-1/3 w-24 h-24 bg-pink-400 rounded-full blur-3xl opacity-25" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">welcome back we missed you</p>
          </div>
          ...
          <div className="text-center mt-6">
            ...
            <button onClick={onSignUp} className="text-purple-400 hover:text-purple-300 transition-colors">
              Sign up
            </button>
          </div>
        </div>
